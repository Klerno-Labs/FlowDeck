  ...
  return (
    <>
        ...
        <div className="absolute top-8 right-8 z-30 flex gap-2">
          {Array.from({ length: totalSlides }).map((_, index) => (
            <button
              ...
              className={`w-3 h-3 rounded-full transition-all touch-manipulation min-w-[44px] min-h-[44px] flex items-center justify-center ${
      ...
      {showPrevNext && !disablePrevious && (
        <button
          onClick={onPrevious}
          className="absolute left-4 top-1/2 -translate-y-1/2 z-30 w-12 h-12 rounded-full bg-white/90 hover:bg-white shadow-lg transition-all flex items-center justify-center touch-manipulation"
          aria-label="Previous"
      ...
      {showPrevNext && !disableNext && (
        <button
          onClick={onNext}
          className="absolute right-4 top-1/2 -translate-y-1/2 z-30 w-12 h-12 rounded-full bg-white/90 hover:bg-white shadow-lg transition-all flex items-center justify-center touch-manipulation"
          aria-label="Next"
