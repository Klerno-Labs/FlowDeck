/**
 * Version History API for Knowledge Base Slides
...
/**
 * POST /api/versions/knowledge_slide/[slideId]
...
/**
 * GET /api/versions/knowledge_slide/[slideId]
...
export async function GET(
  ...
  try {
    ...
    // Get version history
    const versions = await getVersionHistory('knowledge_slide', slideId, limit);
