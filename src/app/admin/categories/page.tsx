...
// Simplified category modal - keeping the old table view below for reference
function OldTableView() {
  return (
              ...
              categories.map((category) => (
                <tr key={category.id} className="hover:bg-gray-50">
                  <td className="px-6 py-4 whitespace-nowrap">
                    <span className="inline-flex items-center justify-center w-10 h-10 rounded-full text-white font-bold" style={{ backgroundColor: category.background_color }}>
                      {category.code}
                    </span>
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="flex items-center gap-2">
                      <div className="w-6 h-6 rounded border border-gray-300" style={{ backgroundColor: category.background_color }}></div>
                      <span className="text-sm text-gray-600">{category.background_color}</span>
                    </div>
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
