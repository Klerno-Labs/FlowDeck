...
import { Home, Package, Layers, LayoutGrid, FileText, ArrowLeft } from 'lucide-react';
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <div className="flex items-center gap-6">
                      ...
                      <div className="flex items-center gap-2 ml-8">
                        ...
                        <NavTab href="/admin/content-editor" icon={<FileText className="w-5 h-5" />} label="Content Editor" />
